...
/**
 * Odometer class, tracing the coordinates of the robot
 * @author Percy Chen
...
public class Odometer extends OdometerData implements Runnable {
  ...
  /**
   * This method transfer the rotation degree of wheel to distance covered
   * 
   * @param degree: angle in degree
   * @return distance in cm covered by the wheel
   */
  ...
  /**
   * This method calculates the delta anlge of the robot left and right displacements
   * 
   * @param l: left displacement
   * @param r: right displacement
   * @return rotation in radians of the robot
   */
  ...
  /**
   * This method calculates the delta displacement in X direction of the robot
   * 
   * @param d: displacement
   * @param rotation: accumulate rotation in radians
   * @return delta displacement in x direction
   */
  ...
  /**
   * This method calculates the delta displacement in y direction of the robot
   * 
   * @param d: displacement
   * @param rotation: accumulate rotation in radians
   * @return delta displacement in y direction
   */
